...
const steps = [
  { emoji: "📸", title: "Share what you've outgrown", description: "Snap a photo. Add details. Post in seconds." },
  { emoji: "💛", title: "Find something you love", description: "Find something you love. Offer something you have." },
  { emoji: "🤝", title: "Meet up and exchange", description: "Meet nearby. Exchange. Feel good about it." },
];
  ...
  return (
    <div className="min-h-screen bg-[#FAF5EF]">
      ...
      <section className="relative overflow-hidden pb-16 md:pb-24">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-6 md:pt-12">
          ...
          <div className="flex items-center justify-between mb-10 md:mb-16">
            <Link href="/">
              <Image src="/skifte-logo.png" alt="Skifte Collective" width={140} height={56} className="h-10 w-auto object-contain" />
            </Link>
            <div className="flex items-center gap-2">
              <Link href="/auth">
                <Button variant="ghost" className="text-sm font-medium text-[#C96A3A]/80 hover:text-[#C96A3A]">Sign In</Button>
              </Link>
              <Link href="/auth?tab=signup">
                <Button className="bg-[#C96A3A] hover:bg-[#A85530] text-white rounded-full px-5 text-sm font-semibold">Join Free</Button>
              </Link>
            </div>
          </div>
            ...
            <FadeIn direction="none" duration={0.7}>
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                  ...
                  <Link href="/auth">
                    <Button size="lg" variant="outline" className="rounded-full px-7 text-base font-medium border-[#C96A3A]/30 text-[#C96A3A] hover:bg-[#C96A3A]/5">
                      Sign in
                    </Button>
                  </Link>
                </div>
            ...
            <FadeIn delay={0.25} direction="none" duration={0.7}>
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-3">
                  ...
                  <div className="rounded-2xl overflow-hidden aspect-square shadow-md">
                    <Image src="/wooden-toy.jpg" alt="Wooden toy" width={300} height={300} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                </div>
                <div className="space-y-3 mt-8">
                  <div className="rounded-2xl overflow-hidden aspect-square shadow-md">
                    <Image src="/onesie-bundle.jpg" alt="Onesie bundle" width={300} height={300} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="rounded-2xl overflow-hidden aspect-square shadow-md">
                    <Image src="/board-books.jpg" alt="Board books" width={300} height={300} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                </div>
              </div>
            </FadeIn>
          ...
          {/* Items swapped — BELOW the grid, not overlapping */}
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <FadeInOnScroll>
            <div className="text-center mb-12">
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-[#3B1F0E] mb-3">How it works</h2>
              <p className="text-[#3B1F0E]/50 max-w-sm mx-auto">Three steps. Zero waste. All the good vibes.</p>
            </div>
          </FadeInOnScroll>
            ...
            {steps.map((step, i) => (
              <StaggerItem key={i}>
                <motion.div
                  ...
                  className="bg-[#FAF5EF] rounded-2xl p-7 text-center border border-[#E5D5BD]"
                >
                  <span className="text-4xl mb-4 block">{step.emoji}</span>
                  <p className="text-[11px] font-bold tracking-widest uppercase text-[#C96A3A] mb-2">Step {i + 1}</p>
                  <h3 className="font-heading text-lg font-bold mb-2 text-[#3B1F0E]">{step.title}</h3>
                  <p className="text-sm text-[#3B1F0E]/50 leading-relaxed">{step.description}</p>
                </motion.div>
              </StaggerItem>
            ))}
          </StaggerOnScroll>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <FadeInOnScroll>
            <div className="flex items-end justify-between mb-8">
              <div>
                <h2 className="font-heading text-3xl md:text-4xl font-bold text-[#3B1F0E] mb-1">Fresh Swaps Near You</h2>
                <p className="text-[#3B1F0E]/50">See what&apos;s swapping in your neighborhood.</p>
              </div>
              <Link href="/auth">
                <Button variant="ghost" className="text-[#C96A3A] gap-1 font-medium">
      ...
      <section className="bg-[#C96A3A] py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
          <FadeInOnScroll>
            ...
            <Link href="/auth?tab=signup">
              <Button size="lg" className="bg-[#F5C842] hover:bg-yellow-400 text-[#3B1F0E] rounded-full px-8 font-bold text-base">
                Explore circles
              </Button>
            </Link>
          </FadeInOnScroll>
      ...
      <section className="bg-[#F5C842] py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
          <FadeInOnScroll>
            <h2 className="font-heading text-3xl md:text-5xl font-bold text-[#3B1F0E] mb-4">Know what to swap, when.</h2>
            <p className="text-[#3B1F0E]/70 text-lg max-w-md mx-auto mb-10">
              Our Baby Stage Guide tells you exactly what to let go of — and what to hold onto — at every age.
            </p>
            <Link href="/auth?tab=signup">
              <Button size="lg" className="bg-[#3A6349] hover:bg-[#2E4F3A] text-white rounded-full px-8 font-bold text-base gap-2">
