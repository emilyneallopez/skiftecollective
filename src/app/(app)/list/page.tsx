...
export default function ListItemPage() {
  ...
  if (submitted) {
    return (
      <div className="max-w-lg mx-auto px-4 py-20 text-center">
        ...
        >
          <h1 className="font-heading text-2xl text-[#8B6E5A] mb-2">It&apos;s live!</h1>
          <p className="font-body text-[#8B6E5A]/60">
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      <FadeIn>
        <h1 className="font-heading text-2xl text-[#8B6E5A] mb-2">Share something</h1>
        <p className="font-body text-[#8B6E5A]/50 mb-8">
        ...
        {step === 1 && (
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">Title</label>
                <Input
              ...
              <div>
                <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">Description</label>
                <Textarea
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">Category</label>
                ...
                <div>
                  <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">Size</label>
              ...
              <div>
                <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">Brand</label>
                <Input
              ...
              <div>
                <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">Condition</label>
                <div className="flex flex-wrap gap-2">
                  {CONDITIONS.map((cond) => (
                    <button
                      key={cond.value}
              ...
              <div>
                <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">Listing Type</label>
                <div className="flex flex-wrap gap-2">
        ...
        {step === 2 && (
          ...
          >
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">Neighborhood</label>
                  <Input
                    value={neighborhood}
                ...
                <div>
                  <label className="text-sm font-body font-medium text-[#8B6E5A]/70 mb-1.5 block">ZIP Code</label>
                  <Input
                    value={zip}
