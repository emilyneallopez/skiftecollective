...
export default function FirstYearPage() {
  ...
  return (
    <div className="px-4 pt-8 pb-24 max-w-lg mx-auto">
      ...
      >
        <h1 className="font-heading text-3xl text-[#8B6E5A] mb-2">The First Year Map</h1>
          ...
          >
            ...
            >
              <div className="flex-1">
                <p className="font-heading text-lg text-[#8B6E5A]">{stage.name}</p>
                <p className="font-body text-xs text-[#8B6E5A]/50">{stage.range}</p>
              </div>
                ...
                >
                  <div className="px-5 pb-5 space-y-4 border-t border-[#E5D5BD]">
                    <div className="pt-4">
                      ...
                      <ul className="space-y-1">
                        {stage.get.map((item, j) => (
                          <li key={j} className="font-body text-sm text-[#8B6E5A]/70 flex items-start gap-2">
                    ...
                    <div className="bg-[#FAF5EF] rounded-2xl p-4 border-l-4 border-[#C96A3A]">
                      ...
                      <p className="font-body text-sm text-[#8B6E5A]/70 leading-relaxed italic">{stage.tip}</p>
                    </div>
                  </div>
                </motion.div>
              )}
      ...
      >
        <p className="font-body text-sm text-[#8B6E5A]/40">
