...
const mockEvents = [
  ...
  },
  {
    ...
    description: "Swap toys while the kids play. Coffee and snacks provided. All ages welcome.",
    rsvps: 17,
  },
  {
    id: "ev-3",
    ...
    location: "Cafe Grumpy, Park Slope",
    description: "New to the neighborhood or just had a baby? Come meet other moms. No agenda, just good conversation.",
    rsvps: 11,
  },
];
    ...
    <div className="pb-24">
      ...
      <div className="relative h-52 bg-gradient-to-br from-primary/30 to-secondary/30">
        <div className="absolute inset-0 flex items-end p-5">
          <button
            onClick={() => router.back()}
            className="absolute top-4 left-4 w-9 h-9 rounded-full bg-black/20 backdrop-blur-sm flex items-center justify-center"
          >
      ...
      <div className="px-4 pt-5 space-y-6">
        ...
        <AnimatePresence mode="wait">
          {!joined ? (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={handleJoin}
              className="w-full h-12 bg-primary text-white rounded-full font-heading text-base"
            >
              Join this circle
            </motion.button>
          ) : (
          ...
          {showJoinCelebration && (
            ...
            >
              ...
              <p className="font-body text-sm text-foreground/60 mt-1">
                You&apos;ll see local swaps, upcoming events, and meet moms nearby.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-heading text-xl text-foreground">Upcoming Events</h2>
            {joined && (
              <button className="flex items-center gap-1 text-xs font-body text-primary">
        ...
        {/* Members */}
        <div>
          <h2 className="font-heading text-xl text-foreground mb-4">Members</h2>
          <div className="space-y-3">
