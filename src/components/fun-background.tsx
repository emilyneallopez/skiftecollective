  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0" aria-hidden="true">
      <svg className="absolute inset-0 w-full h-full opacity-40" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
        ...
        <path d="M750 550 Q770 530 780 550 Q790 570 770 580 Q750 590 740 570 Q730 550 750 540" fill="none" stroke="#3A6349" strokeWidth="4" strokeLinecap="round" opacity="0.06"/>
        {/* Dots */}
        <circle cx="120" cy="250" r="5" fill="#F5C842" opacity="0.12"/>
        <circle cx="400" cy="150" r="4" fill="#C96A3A" opacity="0.08"/>
        <circle cx="700" cy="400" r="6" fill="#3A6349" opacity="0.08"/>
        ...
        <circle cx="50" cy="380" r="4" fill="#3A6349" opacity="0.07"/>
        {/* Waves */}
        <path d="M450 650 Q470 620 490 650 Q510 680 530 650 Q550 620 570 650" fill="none" stroke="#3A6349" strokeWidth="6" strokeLinecap="round" opacity="0.06"/>
        ...
        {/* Extra dots */}
        <circle cx="330" cy="80" r="3" fill="#3A6349" opacity="0.08"/>
